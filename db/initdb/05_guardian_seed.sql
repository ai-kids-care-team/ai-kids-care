...
SELECT
  ...
  '서울시 강남구 역삼동 101', DATE '2026-03-02', NULL, 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
...
SELECT
  ...
  '서울시 강남구 논현동 202', DATE '2026-03-02', NULL, 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
...
SELECT
  ...
  '서울시 강남구 삼성동 303', DATE '2026-03-03', NULL, 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
...
SELECT
  ...
  '서울시 강남구 대치동 404', DATE '2026-03-03', NULL, 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
...
SELECT
  ...
  '서울시 강남구 청담동 505', DATE '2026-03-04', NULL, 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
