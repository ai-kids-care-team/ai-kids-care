...
| [ADR-0011](ADR-0011-extract-codegen-subproject.md) | 抽离 pg-spring-crud-codegen 为独立工程 | **Superseded by ADR-0027 (2026-06-18)** | 方案 A 仓内迁址 + 软指针完成；后续由 ADR-0027 退役删除 |
