...
| [ADR-0022](ADR-0022-cd-github-actions-ghcr-watchtower.md) | CD 改用 GitHub Actions + GHCR + watchtower，退役 Jenkins | **Accepted (2026-06-16)** | release tag 触发构建→冒烟→推 GHCR 私有 `:<版本>`+`:prod`→演示机 watchtower 自动部署；develop 只 CI；AI 不纳入初版；演示数据持久 |
