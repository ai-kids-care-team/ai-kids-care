...
| [SPEC-0002](SPEC-0002-admin-management-approval-endpoints.md) | Admin 管理与审批端点（角色/用户/membership 审批与状态变更） | Approved | Implemented（develop CI 绿；release-gate fresh review 待 develop→main） |
