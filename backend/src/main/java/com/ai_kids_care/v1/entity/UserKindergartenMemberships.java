...
@NoArgsConstructor
@Builder
public class UserKindergartenMemberships {

  
  @NonNull
  @Schema(name = "membership_id", description = "멤버십 ID", requiredMode = Schema.RequiredMode.REQUIRED)
