...
public class UserRoleAssignments {
  ...
  @NonNull
  @Schema(name = "role_assignment_id", description = "권한 할당 ID", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("role_assignment_id")
  private Long roleAssignmentId;

  
  @NonNull
  @Schema(name = "user_id", description = "대상 사용자 ID(USER_ACCOUNT.user_id)", requiredMode = Schema.RequiredMode.REQUIRED)
