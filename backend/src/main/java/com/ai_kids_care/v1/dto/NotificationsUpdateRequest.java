...
public class NotificationsUpdateRequest {
  ...
  @Schema(name = "event_id", description = "관련 이벤트 ID(DETECTION_EVENT.event_id)", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("event_id")
  private Long eventId;

  
  @Schema(name = "recipient_user_id", description = "수신자 사용자 ID(USER_ACCOUNT.user_id)", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
