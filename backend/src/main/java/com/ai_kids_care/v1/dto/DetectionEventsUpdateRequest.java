...
@NoArgsConstructor
@Builder
public class DetectionEventsUpdateRequest {
  ...
  @Schema(name = "room_id", description = "룸/구역 ID(ROOM 테이블 FK 가정)", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("room_id")
  private Long roomId;

  
  @Schema(name = "session_id", description = "탐지 세션 ID(DETECTION_SESSION.session_id)", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
