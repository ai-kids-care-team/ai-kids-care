...
/**
 * 摄像头流更新请求（部分更新语义）— ADR-0026 Phase 1.
 *
 * <p>所有字段均可选；null 值跳过更新。update 不允许更改 camera 关联（cameraId 不在此 DTO 中）。
 * 敏感字段通过 {@code @Schema(hidden = true)} 从 OpenAPI schema 中隐藏。
 */
public class CameraStreamUpdateRequest {
    ...
    public String toString() {
        ...
        return "CameraStreamUpdateRequest{streamType=" + streamType
