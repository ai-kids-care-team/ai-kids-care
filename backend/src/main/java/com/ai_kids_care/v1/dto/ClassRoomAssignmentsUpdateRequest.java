...
/**
 * ClassRoomAssignmentsUpdateRequest
 */
...
@NoArgsConstructor
@Builder
public class ClassRoomAssignmentsUpdateRequest {

  
  @Schema(name = "kindergarten_id", description = "유치원 ID(테넌트/필터링용)", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("kindergarten_id")
  private Long kindergartenId;

  
  @Schema(name = "class_id", description = "반 ID", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("class_id")
  private Long classId;

  
  @Schema(name = "room_id", description = "공간 ID", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("room_id")
  private Long roomId;

  
  @Schema(name = "start_at", description = "사용 시작 일시", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
