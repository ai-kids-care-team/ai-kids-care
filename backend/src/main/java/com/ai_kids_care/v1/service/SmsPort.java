 ...
 * records FAILED on a thrown {@link IllegalStateException}, mirroring the Pushover seam. Swapping the
 * provider only changes the adapter, and tests mock this port instead of hitting a real gateway.
 */
