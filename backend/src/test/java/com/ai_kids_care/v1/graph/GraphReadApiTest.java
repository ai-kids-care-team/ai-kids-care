...
class GraphReadApiTest extends GraphIntegrationTest {
    ...
    private void seedGraphTenant(long kgId, String kgName, long teacherId, String teacherName,
        ...
        writeCypher("""
                ...
                CREATE (ch:Child {child_id: $childId, kindergarten_id: $kgId, name: $childName, child_no: $childNo, status: 'ACTIVE'})
                CREATE (g:Guardian {guardian_id: $guardianId, kindergarten_id: $kgId, name: $guardianName, status: 'ACTIVE'})
