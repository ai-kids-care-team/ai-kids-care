 ...
 * test sources to encode recurring-incident rules (see docs/engineering/incidents.md and
 * docs/engineering/harness.md). These are plain unit tests: no Spring context, no database.
 */
