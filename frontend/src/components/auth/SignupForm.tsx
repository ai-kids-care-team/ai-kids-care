...
export function SignupForm() {
  const {
    ...
    childSearchFirst6, setChildSearchFirst6, childSearchBack7, setChildSearchBack7, verifyChild,
    ...
    filteredRelationshipOptions, agreeTerms, setAgreeTerms, error, successMessage, fieldErrors, isSubmitting, handleSubmit,
    ...
    <div className="w-full max-w-4xl rounded-2xl border border-slate-200 bg-white p-8 shadow-xl">
      <div className="mb-8">
        ...
        <p className="mt-2 text-slate-500 text-sm">
          회원 정보를 입력해 가입 신청을 제출하세요. 승인 전에는 로그인할 수 없습니다.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} noValidate className="space-y-6">
        ...
        {memberType === 'GUARDIAN' && (
          <GuardianForm
            ...
            isChildVerified={isChildVerified}
            isChildVerifying={isChildVerifying}
            childVerificationMessage={childVerificationMessage}
            verifyChild={() => void verifyChild(childSearchFirst6, childSearchBack7)}
            rrnFirst6={rrnFirst6}
        ...
        <div className="flex justify-end pt-2">
          ...
          >
            {isSubmitting ? '신청 처리 중...' : successMessage ? '신청 완료' : '가입 신청'}
          </button>
        </div>
      </form>
