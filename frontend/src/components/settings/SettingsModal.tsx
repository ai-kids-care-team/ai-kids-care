 ...
 * 개인설정 모달.
 *
 * 우상단 사용자 드롭다운의 「개인설정」 진입점이 연다. 본인 PUSH(Pushover)
 * 구독 관리(`PushSubscriptionManager`), 비밀번호 변경(`ChangePasswordCard`),
 * 통지 환경설정(`NotificationPreferenceCard`, UX-08)을 담는다 — 홈 화면이 아니라
 * 여기서만 노출한다.
 *
      ...
      <div className="relative w-full max-w-lg rounded-2xl bg-white p-8 shadow-2xl animate-in fade-in zoom-in duration-200">
        ...
        <ScrollArea className="max-h-[70vh] pr-2">
          <div className="space-y-6">
            <ChangePasswordCard onDone={onClose} />
