...
const APPRECIATION_LETTER: MenuItem = { key: 'APPRECIATION_LETTER', label: '감사편지', path: '/appreciationLetter', sortOrder: 20 };
...
export const MENU_BY_ROLE: Record<MenuRole, MenuItem[]> = {
  ...
  SUPERADMIN: [HOME, DETECTION_EVENT, ANNOUNCEMENTS],
  KINDERGARTEN_ADMIN: [HOME, CCTV_CAMERAS, DETECTION_EVENT, APPRECIATION_LETTER, ANNOUNCEMENTS],
  TEACHER: [HOME, CCTV_CAMERAS, DETECTION_EVENT, APPRECIATION_LETTER, ANNOUNCEMENTS],
  GUARDIAN: [HOME, DETECTION_EVENT, APPRECIATION_LETTER, ANNOUNCEMENTS],
};
