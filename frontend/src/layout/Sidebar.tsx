...
export function Sidebar({ currentRole, userName, cameraStats, onCategoryFilter, currentCategory = 'all' }: SidebarProps) {
  return (
      <div className="w-64 bg-white border-r border-gray-200 h-full flex flex-col">
        ...
        {/* User Info */}
        <div className="p-4 border-b border-gray-200">
          {/* 로그인 정보 헤더 영역을 flex로 분리하여 프로필 링크 추가 */}
          <div className="flex justify-between items-center mb-3">
            <h3 className="text-xs font-semibold text-gray-500 uppercase">로그인 정보</h3>
            <Link href="/profile" className="text-xs text-purple-600 hover:text-purple-800 font-medium transition-colors">
              프로필 설정
            </Link>
          </div>
