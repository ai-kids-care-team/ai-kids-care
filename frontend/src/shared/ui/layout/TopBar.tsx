...
import { logout, useGetNotificationsQuery, useMarkAllNotificationsAsReadMutation } from '@/entities/user';
...
import type { UserRole } from '@/shared/types/anomaly';
import { roleLabels } from '@/shared/types/anomaly';
