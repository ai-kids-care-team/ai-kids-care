...
//import { useGetEventLogsQuery, useUpdateEventStatusMutation } from '@/entities/event';
import { useGetEventsQuery, useUpdateEventStatusMutation } from '@/entities/event/api/eventApi';
import { EventDetailModal } from '@/entities/event';
import { TopBar, Sidebar } from '@/shared/ui/layout';
import { Button } from '@/shared/ui/button';
import type { AnomalyEvent, AnomalyType } from '@/shared/types/anomaly';
