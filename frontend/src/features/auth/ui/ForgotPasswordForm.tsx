    ...
    <div className="w-full max-w-md p-8 bg-white rounded-2xl shadow-2xl">
      ...
      {isSuccess ? (
        <div className="text-center">
          ...
          <Link href="/auth/reset-password" className="block w-full bg-purple-600 hover:bg-purple-700 text-white font-medium py-2.5 rounded-lg transition-colors">
            인증코드 입력하기
          </Link>
        </div>
      ) : (
      ...
      <div className="mt-6 text-center">
        <Link href="/auth/login" className="inline-flex items-center text-sm text-gray-600 hover:text-purple-600 font-medium transition-colors">
