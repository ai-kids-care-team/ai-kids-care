...
import { switchRole } from '@/entities/user';
import { useGetCamerasQuery, CCTVGrid, CameraDetailModal, FullscreenView } from '@/entities/camera';
import { useGetEventsQuery, useUpdateEventStatusMutation, EventDetailModal } from '@/entities/event';
import { useGetDashboardMetricsQuery } from '@/features/dashboard';
import { RightPanel } from '@/features/monitoring';
import { TopBar, Sidebar } from '@/shared/ui/layout';
import { Button } from '@/shared/ui/button';
import type { Camera, AnomalyEvent, AnomalyType } from '@/shared/types/anomaly';
import { rolePermissions } from '@/shared/types/anomaly';
